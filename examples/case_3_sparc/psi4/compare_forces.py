"""Single-point Psi4 PBE/def2-SVP gradient on QM water at frame-0 geometry.
...
Compares against SPARC forces extracted from
``../case_3_sparc/sparc_workdir/SPARC.static_01``.
"""
...
# SPARC forces from SPARC.static_01.  SPARC orders atoms by element
# type: H, H, O.  Reorder to O, H1, H2 to match the Psi4/PDB order.
forces_sparc_HHO = np.array([
    [ 1.8983291118e-02, -4.0325573785e-03, -2.8833179533e-07],
    [ 1.8983282509e-02,  4.0326383286e-03, -2.9405461250e-07],
    [-3.7966573627e-02, -8.0950076905e-08,  5.8238640783e-07],
])
